...
import co.innoshop.android.AppPrefs.DeletablePrefKey.DATABASE_DOWNGRADED
import co.innoshop.android.AppPrefs.DeletablePrefKey.IMAGE_OPTIMIZE_ENABLED
import co.innoshop.android.tools.SelectedSite
import co.innoshop.android.util.PreferenceUtils
...
object AppPrefs {
     ...
     * by clicking the `No thanks` button in the [co.innoshop.android.ui.mystore.MyStoreStatsAvailabilityCard]
     */
     ...
     * The [co.innoshop.android.ui.mystore.MyStoreStatsAvailabilityCard]
    ...
    fun isCrashReportingEnabled(): Boolean {
        ...
        val default = !co.innoshop.android.BuildConfig.DEBUG
