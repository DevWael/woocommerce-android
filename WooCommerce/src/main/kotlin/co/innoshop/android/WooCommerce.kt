...
import co.innoshop.android.di.DaggerAppComponent
import co.innoshop.android.di.WooCommerceGlideModule
import co.innoshop.android.network.ConnectionChangeReceiver
import co.innoshop.android.push.FCMRegistrationIntentService
...
import co.innoshop.android.tools.RateLimitedTask
import co.innoshop.android.tools.SelectedSite
import co.innoshop.android.util.ApplicationLifecycleMonitor
import co.innoshop.android.util.ApplicationLifecycleMonitor.ApplicationLifecycleListener
import co.innoshop.android.util.CrashUtils
import co.innoshop.android.util.PackageUtils
import co.innoshop.android.util.PackageUtils.PACKAGE_VERSION_CODE_DEFAULT
import co.innoshop.android.util.REGEX_API_JETPACK_TUNNEL_METHOD
import co.innoshop.android.util.REGEX_API_NUMERIC_PARAM
...
open class WooCommerce : MultiDexApplication(), HasAndroidInjector, ApplicationLifecycleListener {
    ...
    override fun onCreate() {
        ...
        zendeskHelper.setupZendesk(
                this, co.innoshop.android.BuildConfig.ZENDESK_DOMAIN, co.innoshop.android.BuildConfig.ZENDESK_APP_ID,
                co.innoshop.android.BuildConfig.ZENDESK_OAUTH_CLIENT_ID
        )
    }
