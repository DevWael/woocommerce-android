 ...
 *
 * @see [co.innoshop.android.ui.reviews.ProductReviewModerationRequest] for an example
 * of how this class is implemented.
 * @see [co.innoshop.android.ui.reviews.OnRequestModerateReviewEvent] for an example
