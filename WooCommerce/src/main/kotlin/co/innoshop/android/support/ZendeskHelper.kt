package co.innoshop.android.support
...
import co.innoshop.android.extensions.logInformation
import co.innoshop.android.extensions.stateLogInformation
...
class ZendeskHelper(
    ...
    fun setupZendesk(
        ...
        enableLogs: Boolean = co.innoshop.android.BuildConfig.DEBUG
    ) {
