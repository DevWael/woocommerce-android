...
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_SHIPMENT_TRACKING_ADD_BUTTON_TAPPED
...
class AddOrderShipmentTrackingFragment : BaseFragment(), AddOrderShipmentTrackingContract.View,
    ...
    private val navArgs: co.innoshop.android.ui.orders.AddOrderShipmentTrackingFragmentArgs by navArgs()
