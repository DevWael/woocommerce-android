...
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_DETAIL_ISSUE_REFUND_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_DETAIL_TRACKING_ADD_TRACKING_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_DETAIL_TRACKING_DELETE_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_DETAIL_VIEW_REFUND_DETAILS_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.SNACK_ORDER_MARKED_COMPLETE_UNDO_BUTTON_TAPPED
...
import co.innoshop.android.ui.orders.notes.OrderDetailOrderNoteListView.OrderDetailNoteListener
...
class OrderDetailFragment : BaseFragment(), OrderDetailContract.View, OrderDetailNoteListener,
    ...
    private val navArgs: co.innoshop.android.ui.orders.OrderDetailFragmentArgs by navArgs()
    ...
    override fun openOrderFulfillment(order: WCOrderModel) {
        val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToOrderFulfillmentFragment(
                order.getIdentifier(),
                order.number,
    ...
    override fun issueOrderRefund(order: Order) {
        ...
        val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToIssueRefund(order.remoteId)
        findNavController().navigate(action)
    }
    ...
    override fun showRefundDetail(orderId: Long, refundId: Long) {
        ...
        val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToRefundDetailFragment(orderId, refundId)
        findNavController().navigate(action)
    }

    override fun openOrderProductList(order: WCOrderModel) {
        val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToOrderProductListFragment(
                order.getIdentifier(),
                order.number
        )
        findNavController().navigate(action)
    ...
    override fun openRefundedProductList(order: WCOrderModel) {
        val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToRefundDetailFragment(
                order.remoteOrderId
        )
        findNavController().navigate(action)
    }
    ...
    override fun showAddOrderNoteScreen(order: WCOrderModel) {
        val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToAddOrderNoteFragment(
                order.getIdentifier(),
                order.number
        )
        findNavController().navigate(action)
    ...
    override fun openAddOrderShipmentTrackingScreen() {
        ...
        presenter.orderModel?.let { order ->
            val action = co.innoshop.android.ui.orders.OrderDetailFragmentDirections.actionOrderDetailFragmentToAddOrderShipmentTrackingFragment(
