...
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_FULFILLMENT_MARK_ORDER_COMPLETE_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_FULFILLMENT_TRACKING_ADD_TRACKING_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ORDER_FULFILLMENT_TRACKING_DELETE_BUTTON_TAPPED
...
class OrderFulfillmentFragment : BaseFragment(), OrderFulfillmentContract.View, View.OnClickListener {
    ...
    private val navArgs: co.innoshop.android.ui.orders.OrderFulfillmentFragmentArgs by navArgs()
    ...
    override fun openAddOrderShipmentTrackingScreen() {
        ...
        presenter.orderModel?.let { order ->
            val action =
                    co.innoshop.android.ui.orders.OrderFulfillmentFragmentDirections.actionOrderFulfillmentFragmentToAddOrderShipmentTrackingFragment(
