...
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ADD_ORDER_NOTE_ADD_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.ADD_ORDER_NOTE_EMAIL_NOTE_TO_CUSTOMER_TOGGLED
...
class AddOrderNoteFragment : BaseFragment(), AddOrderNoteContract.View, BackPressListener {
    ...
    private val navArgs: co.innoshop.android.ui.orders.notes.AddOrderNoteFragmentArgs by navArgs()
