...
import co.innoshop.android.analytics.AnalyticsTracker.Stat.PRODUCT_DETAIL_SHARE_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.PRODUCT_DETAIL_UPDATE_BUTTON_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.PRODUCT_DETAIL_VIEW_AFFILIATE_TAPPED
import co.innoshop.android.analytics.AnalyticsTracker.Stat.PRODUCT_DETAIL_VIEW_EXTERNAL_TAPPED
import co.innoshop.android.extensions.formatToMMMdd
import co.innoshop.android.extensions.formatToMMMddYYYY
import co.innoshop.android.extensions.takeIfNotEqualTo
import co.innoshop.android.model.Product
import co.innoshop.android.ui.aztec.AztecEditorFragment
import co.innoshop.android.ui.aztec.AztecEditorFragment.Companion.ARG_AZTEC_EDITOR_TEXT
import co.innoshop.android.ui.aztec.AztecEditorFragment.Companion.AZTEC_EDITOR_REQUEST_CODE
...
import co.innoshop.android.ui.products.ProductType.EXTERNAL
import co.innoshop.android.ui.products.ProductType.GROUPED
...
import co.innoshop.android.widgets.CustomProgressDialog
...
class ProductDetailFragment : BaseProductFragment(), OnGalleryImageClickListener, NavigationResult {
    ...
    private val navArgs: co.innoshop.android.ui.products.ProductDetailFragmentArgs by navArgs()
    ...
    private fun showProductVariations(remoteId: Long) {
        val action = co.innoshop.android.ui.products.ProductDetailFragmentDirections
    ...
    private fun showProductDescriptionEditor(productDescription: String) {
        findNavController().navigate(
                co.innoshop.android.ui.products.ProductDetailFragmentDirections
