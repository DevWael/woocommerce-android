...
import co.innoshop.android.ui.refunds.IssueRefundViewModel.RefundType
        ...
        viewModel.event.observe(viewLifecycleOwner, Observer { event ->
            when (event) {
                is ShowRefundSummary -> {
                    val action = co.innoshop.android.ui.refunds.IssueRefundFragmentDirections.actionIssueRefundFragmentToRefundSummaryFragment()
