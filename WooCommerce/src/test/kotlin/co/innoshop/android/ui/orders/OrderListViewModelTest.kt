...
import co.innoshop.android.ui.orders.list.OrderListItemIdentifier
...
import co.innoshop.android.ui.orders.list.OrderListViewModel.OrderListEvent.ShowErrorSnack
...
import co.innoshop.android.util.getOrAwaitValue
import co.innoshop.android.util.observeForTesting
import co.innoshop.android.viewmodel.BaseUnitTest
import co.innoshop.android.viewmodel.SavedStateWithArgs
import co.innoshop.android.viewmodel.TEST_DISPATCHER
...
class OrderListViewModelTest : BaseUnitTest() {
     ...
     * message being emitted via a [co.innoshop.android.viewmodel.MultiLiveEvent.Event] and the
